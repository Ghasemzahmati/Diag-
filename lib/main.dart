...
class _RasaDashboardScreenState extends State<RasaDashboardScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _disconnect() async {
    ...
    _connection = null;
    if (mounted) setState(() { _connected = false; _connecting = false; _activeActuator = ''; _connectionStatus = 'آماده اتصال'; _udsRequestHeader = ''; _udsResponseHeader = ''; _discoveryMethod = '---'; });
  }
  ...
  Widget _ecuTab() => ListView(padding: const EdgeInsets.all(14), children: [
        ...
        _info('بانک ECU', 'RASA ECU Database v1.2 • $_databaseStatus'),
